...
public class MyCustomPanelFX extends Application {
   ...
   public void start(Stage applicationStage) {
      ...
      scene = new Scene(gridPane, 400, 400); // Create scene containing the grid pane
      ...
      gridPane.setVgap(20);                            // Spacing between rows
      
      gridPane.add(wageLabel, 0, 0, 1, 1);  // Add wage label to location (0, 0)
      gridPane.add(wageField, 1, 0, 2, 1);  // Add wage text field to location (1, 0)
      gridPane.add(salLabel, 0, 1, 1, 1);   // Add salary label to location (0, 1)
      gridPane.add(salField, 1, 1, 1, 1);   // Add salary text field to location (1, 1)
      gridPane.add(calcButton, 0, 2, 1, 1); // Add calculate button to location (0, 2)
